...
const Contact = () => {
  return (
    <div className="bg-black-50 py-16 px-6 md:px-12 mt-32"> {/* Added mt-32 to push content below the navbar */}
      ...
      <div className="my-12 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/2 flex flex-col items-start gap-6 text-gray-700">
          <p className="font-semibold text-2xl text-gray-900">OUR HOSTEL</p>
          ...
          <p className="text-lg text-gray-600 leading-relaxed">Tel: (123) 456-7890 <br /> Email: <a href="mailto:DormMate@gmail.com" className="text-primary font-semibold hover:underline">DormMate@gmail.com</a></p>

          <p className="font-semibold text-2xl text-gray-900">JOIN OUR COMMUNITY</p>
          <p className="text-lg text-gray-600 leading-relaxed">Looking for a vibrant and comfortable stay? Explore our hostel facilities.</p>
